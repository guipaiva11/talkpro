    ...
    return (
      <section className="w-full px-4 py-10 text-center">
        ...
        <div className="flex flex-col md:flex-row justify-center items-stretch gap-6 mb-8">
          ...
          <div className="bg-indigo-100 rounded-xl p-6 w-full md:w-80 text-left shadow">
            <h3 className="font-semibold text-lg mb-2">Precisa de ajuda?</h3>
            <p className="text-sm pb-3">Leia o manual da Talk Pro</p>
            <a href="/manual">
                <button className="bg-white text-black border border-gray-300 px-2 py-2 rounded hover:bg-gray-100 transition">
                    Manual
                </button>
            </a>
          </div>
          <div className="bg-indigo-100 rounded-xl p-6 w-full md:w-80 text-left shadow">
            ...
            <div className="w-full h-20 bg-gray-300 rounded-md flex items-center justify-center text-gray-600 text-sm">
              Vídeo
            </div>
          </div>
        </div>
        <div className="bg-indigo-100  rounded-xl p-6 max-w-2xl mx-auto text-left shadow">
